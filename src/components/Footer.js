...
// To use Animate.css, please add the following line to the <head> of your public/index.html file:
...
                </li>
                <li>
                <a href="mailto:siteorawebsolutions@gmail.com" className="text-gray-300 hover:text-green-400 transition-colors duration-300 flex items-center justify-center md:justify-start transform hover:translate-x-1 hover:text-white">
